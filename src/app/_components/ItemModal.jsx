...
//           {isGrillItem && (
//             <div className="mb-6">
//               <h3 className="text-lg font-bold text-white mb-3">اختر الحجم:</h3>
//               <div className="grid grid-cols-3 gap-2">
//                 {grillSizes.map((size) => {
//                   const sizePrice = Math.round(basePrice * size.multiplier);
//                   return (
//                     <motion.button
//                       key={size.value}
//                       whileTap={{ scale: 0.95 }}
